...
def parse_args():
    ...
    parser.add_argument('--output-dir', help='path to save plots to', type=str, default='./results/crossval_plot/')
    parser.add_argument('--save-path', help='path to save plots to', type=str, default='debias_output_fitzpatrick_skin.csv')
