...
class SkinNetLitModule(LightningModule):
    ...
    def __init__(
        ...
        # self.append_dropout(self.net, rate=0.2)
    ...
    def model_step(
        ...
        # class_weights = [count_neg/(count_pos+count_neg), count_pos/(count_pos+count_neg)]
    ...
    def training_step(
        ...
        self.train_acc(torch.round(preds), targets)
    ...
    def validation_step(self, batch: Tuple[torch.Tensor, torch.Tensor], batch_idx: int) -> None:
        ...
        self.val_loss(loss)
        self.val_acc(torch.round(preds), targets)
